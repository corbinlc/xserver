...
class Globals
{
	...
	public static String AppLibraries[] = { "sdl_native_helpers", "sdl-1.2", "sdl_ttf" };
	public static String AppMainLibraries[] = {  "application", "sdl_main" };
	public static final boolean Using_SDL_1_3 = false;
	public static final boolean Using_SDL_2_0 = false;
	public static String[] DataDownloadUrl = { "!!Data files|:data.tar.gz:data-1.tgz", "!!Data files|:DroidSansMono.ttf:DroidSansMono.ttf",  };
	...
	public static String[] AppTouchscreenKeyboardKeysNames = "LALT RETURN KP_PLUS KP_MINUS SPACE DELETE PLUS MINUS UNDO KEYBOARD".split(" ");
